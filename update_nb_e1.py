...
for cell in nb['cells']:
    if cell['id'] == 'user-config':
        ...
        cell['source'] = [
            ...
            'print("Model pre-verification successful!")\n'
        ]
        new_cells.append(cell)
        ...
        cell['source'] = [
            ...
            '        \n',
            '        # Load pre and post fold json if available\n',
            ...
            '    \n',
            '    ft_cfg = config.get("fine_tuning", {})\n',
            '    apply_fine_tuning_strategy(dummy_model, strategy=ft_cfg.get("strategy", "full"))\n',
            ...
            '        \'total_params\': int(dummy_model.count_params()),\n',
